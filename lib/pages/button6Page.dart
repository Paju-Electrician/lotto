        ...
        builder: (context) {
          return AlertDialog(
            ...
            title: Column(
              ...
              children: <Widget>[
                AutoSizeText("$a는 여러번호를 의미해요"),
                const AutoSizeText("번호를 선택해주세요")
              ],
            ),
            //
            content: Column(
            ...
            actions: <Widget>[
              TextButton(
                child: const AutoSizeText("아니오, 이어서 검색할래요"),
                onPressed: () {
                  Navigator.pop(context);
                },
              ),
        ...
        children: [
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const AutoSizeText('로또번호 꿈풀이',
                      style: TextStyle(
          ...
          SizedBox(
              ...
              child: Row(children: [
                ...
                // Container(child: ElevatedButton(onPressed: () {}, child: AutoSizeText('꿈 검색',style:TextStyle(fontSize: 20),)))
              ])),
          Expanded(
            child: Container(
