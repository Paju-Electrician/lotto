...
class _button4PageState extends State<button4Page>
  ...
  onTapButton() {
    ...
    if (switchbool1 == false) {
      ...
      setState(() {
        alignmentList[0] = Alignment(-screenWidth/450, -screenHeight/1200 );
        // print('alignmnet는ㄴㄴㄴㄴㄴㄴㄴㄴㄴㄴㄴ');
        // print(alignmentList[0]);
        switchbool1 = true;
        return;
      });
    } else if (switchbool2 == false) {
      setState(() {
        alignmentList[1] =   Alignment(-screenWidth/750, -screenHeight/1200);
        switchbool2 = true;
        return;
      });
    } else if (switchbool3 == false) {
      setState(() {
        alignmentList[2] = Alignment(-screenWidth/2300, -screenHeight/1200);
        switchbool3 = true;
        return;
      });
    } else if (switchbool4 == false) {
      setState(() {
        alignmentList[3] = Alignment(screenWidth/2300, -screenHeight/1200);
        switchbool4 = true;
        return;
      });
    } else if (switchbool5 == false) {
      setState(() {
        alignmentList[4] =  Alignment(screenWidth/750, -screenHeight/1200);
        switchbool5 = true;
        return;
      });
    } else if (switchbool6 == false) {
      setState(() {
        alignmentList[5] =  Alignment(screenWidth/450,-screenHeight/1200);
        switchbool6 = true;
        return;
      });
    }
  ...
  onResetButton() {
    setState(() {
      ...
      switchbool5 = false;
      switchbool6 = false;
      alignmentList[0] = Alignment(0, 0.h);
      alignmentList[1] = Alignment(0.w, 0.h);
      alignmentList[2] = Alignment(0, 0.h);
      alignmentList[3] = Alignment(0, 0.h);
      alignmentList[4] = Alignment(0.w, 0.h);
      alignmentList[5] = Alignment(0.w, 0.h);
      button4RandomNumber =
          (List<int>.generate(45, (i) => i + 1)..shuffle()).sublist(0, 6);
    });
  }
